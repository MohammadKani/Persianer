...
## پرشینر : تجربه روان فارسی در وب - راهنمای حالت‌های توسعه و تولید

This guide explains how to work with development and production modes in the Persianer extension.

این راهنما نحوه کار با حالت‌های توسعه و تولید در افزونه Persianer را توضیح می‌دهد.
